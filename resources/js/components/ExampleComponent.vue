                    ...
                    >
                        ...
                        <tab-content title="İş Detayı" icon="la la-info">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="pf-field">
                                    <textarea v-model="formInline.description"
                                              placeholder="Sizinle çalışırken ne iş yapacağı, kaç saat çalışacağı gibi bilgileri yazınız...Aylık ya da haftalık ücret, yol yemek parası, sigorta gibi çalışana sağlayacağınız şartları yazınız..."></textarea>
                                </div>
                            </div>
                        </tab-content>
