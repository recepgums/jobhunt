        ...
        <div class="container">
            <div class="row no-gape">
                <aside class="col-lg-3 column border-right">
                    <form action="{{route('job.index')}}" method="get" class="tw-hidden lg:tw-visible">
                        <div class="widget">
                            <div class="search_widget_job ">
                                ...
                                <div class="field_w_search">
                                    <select name="city_id" data-placeholder="Uzmanlık Seçin" class="chosen"
                                        onchange="cityChangedMethod(this)">
                                        <option value></option>
                                ...
                                <div class="field_w_search" id="districtSelect">
                                    <select name="district_id[]" data-placeholder="İlçe Seçin"
                                        ...
                                        <option @if(request()->has('district_id') &&
                                            is_array(request()->get('district_id')))
                                ...
                                <div class="simple-checkbox scrollbar">
                                    ...
                                    <p>
                                        <input type="checkbox" value="{{$category->id}}" name="category_id[]"
                                            id="categoty_{{$key}}" @if(request()->has('category_id'))
                        ...
                        <div class="widget">
                            ...
                            <div class="posted_widget">
                                <input type="radio" @if(request()->get('created_at') == 24) checked @endif
                                name="created_at" value="24" id="wwqe"><label for="wwqe">Son 24
                                    Saat</label><br />
                                <input type="radio" @if(request()->get('created_at') == 168) checked @endif
                                name="created_at" value="168" id="erewr"><label for="erewr">Son
                                    7 Gün</label><br />
                                <input type="radio" @if(request()->get('created_at') == 336) checked @endif
                                name="created_at" value="336" id="qwe"><label for="qwe">Son 14
                                    Gün</label><br />
                                <input type="radio" @if(request()->get('created_at') == 720) checked @endif
                                name="created_at" value="720" id="wqe"><label for="wqe">Son 30
                                    Gün</label><br />
                                <input type="radio" @if(!request()->has('created_at')) checked @endif name="created_at"
                                id="qweqw">
                    ...
                    <div class="modrn-joblist">
                        ...
                        <div class="filterbar">
                            ...
                            <div class="sortby-sec">
                                <span>Sıralama</span>
                                <select onchange="sortTypeChangedMethod(this)" name="order_by"
                                    data-placeholder="Most Recent" class="chosen">
                            ...
                            {{--                                @if(isset($jobs) && $jobs->total() > 0 )<h5>{{$jobs->total()}}
                            İş İlanı </h5>@endif--}}
                        </div>
                    </div><!-- MOdern Job LIst -->
                                ...
                                <div class="job-style-bx" style="top: 40%;right: -10%">
                                    <a href="{{route('job.show',$job->slug)}}">
                                        <span class="job-is ft"
                                            style="position: absolute;bottom: 0;padding: 12px;width: 130px;font-size: 14px;font-weight: 700">
                                            İletişime Geç
                                        </span>
                                    </a>
                                </div>
