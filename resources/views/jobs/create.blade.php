                                ...
                                <form method="post" action="{{route('job.store')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="pf-field">
                                                <select name="type" data-placeholder="Please Select Specialism"
                                                        class="chosen">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="pf-field">
                                                <select name="city" data-placeholder="Please Select Specialism"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="pf-field">
                                                <input type="text" placeholder="Ucret" name="fee">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <span class="pf-title">Cinsiyet</span>
                                            <div class="pf-field">
                                                <select name="gender" data-placeholder="Please Select Specialism" class="chosen">
                                        ...
                                        {{--<div class="col-lg-6">
                                            <span class="pf-title">İlan yayınlanma süresi</span>
                                            <div class="pf-field">
                                                <select name="publish_days" data-placeholder="Please Select Specialism" class="chosen">
        ...
        function cityChangedMethod(element) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    let html = '<select name="district_id" data-placeholder="İlçe Seçin" class="chosen">';
