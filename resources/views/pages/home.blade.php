                            ...
                            <div aria-live="polite" class="slick-list draggable">
                                <div class="slick-track"
                                    ...
                                    <li class="slideHome slick-slide slick-cloned" data-slick-index="-1"
                                        aria-hidden="true" style="width: 394px;" tabindex="-1">
                ...
                <div class="col-lg-9 column">
                        ...
                        <div class="job-listing py-1 row">
                            ...
                            <div class="col-sm-2 text-right">
                                ...
                                <p class="job-is float-right">
                                    <a href="{{route('job.show',$job->slug)}}" title="" class="btn btn-success">Hemen
                                        Başvur</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="job-listings-sec style2 d-block d-md-none">
                        ...
                        <div class="job-listing pr-0" @if(!$loop->last) style="border-bottom: 1px solid #ccc;" @endif>
                            ...
                            <a href="{{route('job.show',$job->slug)}}" title="" class="aply-btn rounded-0 py-3"
                                style="width: 100%;font-size: 20px">Hemen Başvur</a>
                        </div>
                        <hr>
                        @empty
                        @endforelse
